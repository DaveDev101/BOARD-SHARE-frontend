...
mixin _$AccountStatus {
  int get accountStatusId => throw _privateConstructorUsedError;
...
abstract class $AccountStatusCopyWith<$Res> {
  ...
  @useResult
  $Res call({int accountStatusId, String accountStatus});
}
...
class _$AccountStatusCopyWithImpl<$Res, $Val extends AccountStatus>
  ...
  @override
  $Res call({
    Object? accountStatusId = null,
    Object? accountStatus = null,
  }) {
    return _then(_value.copyWith(
      accountStatusId: null == accountStatusId
          ? _value.accountStatusId
          : accountStatusId // ignore: cast_nullable_to_non_nullable
              as int,
...
class _$AccountStatusImpl implements _AccountStatus {
  const _$AccountStatusImpl(
      {required this.accountStatusId, this.accountStatus = "unknown"});
  ...
  bool operator ==(Object other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            ...
            (identical(other.accountStatusId, accountStatusId) ||
                other.accountStatusId == accountStatusId) &&
...
abstract class _AccountStatus implements AccountStatus {
  const factory _AccountStatus(
      {required final int accountStatusId,
      final String accountStatus}) = _$AccountStatusImpl;

  factory _AccountStatus.fromJson(Map<String, dynamic> json) =
      _$AccountStatusImpl.fromJson;

  @override
  int get accountStatusId;
  @override
