...
import 'package:boardshare/app/user/controllers/favorite_board_at_index_ctl.dart';
...
class FavoriteBoardCard extends HookConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final (index, search) = ref.watch(favoriteBoardAtIndexCondition);
    // final page = (index ~/ kQueryLimit) + 1;

    final boardAtIndex = ref.watch(
      favoriteBoardAtIndexCtlProvider(index, searchTerm: search),
    );
                ...
                children: [
                  ...
                  LayoutBuilder(
                    builder: (context, constraints) {
                      return SizedBox(
                        height: constraints.maxWidth - 100.0,
                        child: ClipRect(
