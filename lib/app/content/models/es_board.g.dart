...
_ESBoard _$ESBoardFromJson(Map<String, dynamic> json) => _ESBoard(
  ...
  media: (json['media'] as List<dynamic>?)
      ?.map((e) => ESMedium.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$ESBoardToJson(_ESBoard instance) => <String, dynamic>{
