...
@override
String toString() {
  return 'ESMedium(sequence: $sequence, mediumId: $mediumId, isMain: $isMain, screenX: $screenX, screenY: $screenY, customTitle: $customTitle, mediumPath: $mediumPath, mediumUrl: $mediumUrl, mediumMimeType: $mediumMimeType, authorID: $authorID, authorOrgID: $authorOrgID, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
/// @nodoc
abstract mixin class $ESMediumCopyWith<$Res>  {
  factory $ESMediumCopyWith(ESMedium value, $Res Function(ESMedium) _then) = _$ESMediumCopyWithImpl;
@useResult
$Res call({
...
/// @nodoc
class _$ESMediumCopyWithImpl<$Res>
    implements $ESMediumCopyWith<$Res> {
  _$ESMediumCopyWithImpl(this._self, this._then);

  final ESMedium _self;
  final $Res Function(ESMedium) _then;
...
/// Adds pattern-matching-related methods to [ESMedium].
extension ESMediumPatterns on ESMedium {
...
@optionalTypeArgs TResult maybeMap<TResult extends Object?>(TResult Function( _ESMedium value)?  $default,{required TResult orElse(),}){
final _that = this;
switch (_that) {
case _ESMedium() when $default != null:
...
@optionalTypeArgs TResult map<TResult extends Object?>(TResult Function( _ESMedium value)  $default,){
final _that = this;
switch (_that) {
case _ESMedium():
...
@optionalTypeArgs TResult? mapOrNull<TResult extends Object?>(TResult? Function( _ESMedium value)?  $default,){
final _that = this;
switch (_that) {
case _ESMedium() when $default != null:
return $default(_that);case _:
...
class _ESMedium implements ESMedium {
  const _ESMedium({@JsonKey(includeIfNull: false) this.sequence, @JsonKey(includeIfNull: false) this.mediumId, @JsonKey(includeIfNull: false) this.isMain, @JsonKey(includeIfNull: false) this.screenX, @JsonKey(includeIfNull: false) this.screenY, @JsonKey(includeIfNull: false) this.customTitle, @JsonKey(includeIfNull: false) this.mediumPath, @JsonKey(includeIfNull: false) this.mediumUrl, @JsonKey(includeIfNull: false) this.mediumMimeType, @JsonKey(includeIfNull: false) this.authorID, @JsonKey(includeIfNull: false) this.authorOrgID, @JsonKey(includeIfNull: false) this.createdAt, @JsonKey(includeIfNull: false) this.updatedAt});
  factory _ESMedium.fromJson(Map<String, dynamic> json) => _$ESMediumFromJson(json);
...
@pragma('vm:prefer-inline')
_$ESMediumCopyWith<_ESMedium> get copyWith => __$ESMediumCopyWithImpl<_ESMedium>(this, _$identity);

@override
Map<String, dynamic> toJson() {
  return _$ESMediumToJson(this, );
}

@override
bool operator ==(Object other) {
  return identical(this, other) || (other.runtimeType == runtimeType&&other is _ESMedium&&(identical(other.sequence, sequence) || other.sequence == sequence)&&(identical(other.mediumId, mediumId) || other.mediumId == mediumId)&&(identical(other.isMain, isMain) || other.isMain == isMain)&&(identical(other.screenX, screenX) || other.screenX == screenX)&&(identical(other.screenY, screenY) || other.screenY == screenY)&&(identical(other.customTitle, customTitle) || other.customTitle == customTitle)&&(identical(other.mediumPath, mediumPath) || other.mediumPath == mediumPath)&&(identical(other.mediumUrl, mediumUrl) || other.mediumUrl == mediumUrl)&&(identical(other.mediumMimeType, mediumMimeType) || other.mediumMimeType == mediumMimeType)&&(identical(other.authorID, authorID) || other.authorID == authorID)&&(identical(other.authorOrgID, authorOrgID) || other.authorOrgID == authorOrgID)&&(identical(other.createdAt, createdAt) || other.createdAt == createdAt)&&(identical(other.updatedAt, updatedAt) || other.updatedAt == updatedAt));
}
...
/// @nodoc
abstract mixin class _$ESMediumCopyWith<$Res> implements $ESMediumCopyWith<$Res> {
  factory _$ESMediumCopyWith(_ESMedium value, $Res Function(_ESMedium) _then) = __$ESMediumCopyWithImpl;
@override @useResult
$Res call({
@JsonKey(includeIfNull: false) int? sequence,@JsonKey(includeIfNull: false) int? mediumId,@JsonKey(includeIfNull: false) bool? isMain,@JsonKey(includeIfNull: false) double? screenX,@JsonKey(includeIfNull: false) double? screenY,@JsonKey(includeIfNull: false) String? customTitle,@JsonKey(includeIfNull: false) String? mediumPath,@JsonKey(includeIfNull: false) String? mediumUrl,@JsonKey(includeIfNull: false) String? mediumMimeType,@JsonKey(includeIfNull: false) int? authorID,@JsonKey(includeIfNull: false) int? authorOrgID,@JsonKey(includeIfNull: false) DateTime? createdAt,@JsonKey(includeIfNull: false) DateTime? updatedAt
});
...
/// @nodoc
class __$ESMediumCopyWithImpl<$Res>
    implements _$ESMediumCopyWith<$Res> {
  __$ESMediumCopyWithImpl(this._self, this._then);

  final _ESMedium _self;
  final $Res Function(_ESMedium) _then;
